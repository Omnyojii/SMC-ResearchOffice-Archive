...
<head>
    ...
    <link rel="alternate" href="https://netdna.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css"
        ...
        <form action="" method="POST" class="searchform" style="max-width:85%">
            ...
            <div class="college-box col-12">
                <div class="col-1-2 CECS">
                    <input type="checkbox" class="college-chkbx " id="CECS" name="check_list[]" value="CECS"><label
                        for="CECS">CECS</label>
                </div>
                <div class="col-1-2 CHRM">
                    <input type="checkbox" class="college-chkbx " id="CHRM" name="check_list[]" value="CHRM"><label
                        for="CHRM">CHRM</label>
                </div class="col-2">
                <div class="col-1-2 COC">
                    <input type="checkbox" class="college-chkbx " id="COC" name="check_list[]" value="COC"><label
                        for="COC">COC</label>
                </div>
                <div class="col-1-2 CBAA">
                    <input type="checkbox" class="college-chkbx " id="CBAA" name="check_list[]" value="CBAA"><label
                        for="CBAA">CBAA</label>
                </div>
                <div class="col-1-2 CAS">
                    <input type="checkbox" class="college-chkbx " id="CAS" name="check_list[]" value="CAS"><label
                        for="CAS">CAS</label>
                </div>
                <div class="col-1-2 CON">
                    <input type="checkbox" class="college-chkbx " id="CON" name="check_list[]" value="CON"><label
                        for="CON">CON</label>
                </div>
                <div class="col-1-2 CED">
                    <input type="checkbox" class="college-chkbx " id="CED" name="check_list[]" value="CED"><label
                        for="CED">CED</label>
                </div>
            </div>
        </form>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center; width:3%;">
                            <div>
                                ...
                                <a title="View" class="yourlink" target="_blank" href="<?php echo $row['filename']; ?>"
                                    onclick="javascript: setlog(<?php echo $row['book_id']; ?>)"><i
                                        class="fas fa-external-link-alt"></i></a>
                                <?php
                                            if ($_SESSION['cuser']['UserType'] == 'admin' || $_SESSION['cuser']['UserType'] == 'superadmin') {
                                            ?>
                                <a title="Delete" href="#"
                                    onclick="javascript: deleteAccount(<?php echo $row['book_id']; ?>)"><i
