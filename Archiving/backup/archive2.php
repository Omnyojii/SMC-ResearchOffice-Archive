...
<body>
   <nav>
      <div class="navbar">
         <a href="dashboard2.php" class="" ><i class="fa fa-fw fa-home"></i> Home</a> 
         <a href="archive2.php" class="active"><i class="fas fa-archive"></i> Archive</a> 
                ...
                <?php
                    if (isset($_GET['search']) && !$_GET['search']){
                        ...
                        <tr>
                            ...
                            <td><div><a target="_blank" href="<?php echo $row['filename'] ?>"></a> | <a href="#" onclick="javascript: deleteAccount(<?php echo $row['book_id']; ?>)">Delete</a></div></td>
                        </tr>
                <?php }} else {
                    while($row = mysqli_fetch_array($result)){ ?>
                        <tr>
                            ...
                            <td><?php echo $row['upload_date']; ?></td>
                            <td><?php echo $row['filename']; ?></td>
                            <td><div><a target="_blank" href="<?php echo $row['filename'] ?>">View File</a> | <a href="#" onclick="javascript: deleteAccount(<?php echo $row['book_id']; ?>)">Delete</a></div></td>
                        </tr>
                <?php }}?>
            </tbody>
        </table>
